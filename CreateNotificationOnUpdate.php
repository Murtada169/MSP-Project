<!-- 
    This PHP script is called from the edit function in booking module
    ...
    - set content to 'Your appointment with booking ID bookingID has been updated by username'

...
<body style="background-color: #BCD9EC;">
	...
	<div class="formdetails">
		...
		<input class="form" type="text" name="accountID"  value="<?php echo $accountID; ?>">
		
		<label><h4><b>First Name: </b></h4></label>
		<input class="form" type="text" name="fname" value="<?php echo $fname; ?>">

		<label><h4><b>Last Name: </b></h4></label>
		<input class="form" type="text" name="lname" value="<?php echo $lname; ?>">

		<label><h4><b>Date of Birth: </b></h4></label>
		<input class="form" type="text" name="DOB" value="<?php echo $DOB; ?>">

        <label><h4><b>Email: </b></h4></label>
		<input class="form" type="text" name="email" value="<?php echo $email; ?>">
        
        <label><h4><b>Username: </b></h4></label>
		<input class="form" type="text" name="username" value="<?php echo $username; ?>">

		<label><h4><b>Password: </b></h4></label>
		<input class="form" type="text" name="password" value="<?php echo $password; ?>">

		<label><h4><b>Phone Number: </b></h4></label>
		<input class="form" type="text" name="phoneno" value="<?php echo $phoneno; ?>">

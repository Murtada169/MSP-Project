...
<body>
	...
	<div class="main">
		<h1  id = "text1" class="fill">Add Multiple Appointment</h1>

		<div class="container">
		<form id="form" method="post"  action = confirmAddMultipleBooking.php>
				<div class="details">
				<div class="row">
        <div class="col-25">
...
<div class="row">
        <div class="col-25">
					<label for="fnum"> Number of Days: * </label>
	</div>
			     <div class="col-75">					
					<input id="fnumber" name="fnumber" type="number" placeholder="2" min="0" required/><br/><br/><br/>
	</div>
	</div>
				</div>
